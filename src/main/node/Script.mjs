...
export class Scripts {
	...
	loadScripts(json, selector, url) {
		...
		*/
		    ...
		    /*
		document.getElementById("routes").remove();
	...
	processScripts(object, classes, mypackage, routecode, loopItems, selector, url) {
		// x3dom native
		classes.log("if (typeof x3dom !== 'undefined' && typeof x3dom.fields !== 'undefined') {");
		...
		classes.log("    var MFString = function() { return Array.prototype.slice.call(arguments, 0); };");
		classes.log("}");
		...
		classes.log("	var document = { querySelector : function(selector) {;");
		classes.log("		return {");
		...
		classes.log("		}");
		*/
		classes.log("		var element = (document ? document.querySelector(selector) : null);");
		...
		classes.log("			}");
		classes.log("			document ? document.querySelector(selector).attr(field, value) : console.error('No document');");
		...
		classes.log("			return document.querySelector(selector)[0];");
		classes.log("		} else {");
		classes.log("			return;");
		classes.log("		}");
		classes.log("};");
