...
X3DJSON['Script']['Scene']['../data/arcold.json']['MB1'] = function() {
...
X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1'] = new X3DJSON['Script']['Scene']['../data/arcold.json']['MB1']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1']['ACTION'],X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1'].initialize === "function") X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/arcold.json']['S1'] = function() {
...
X3DJSON['Obj']['Scene']['../data/arcold.json']['S1'] = new X3DJSON['Script']['Scene']['../data/arcold.json']['S1']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/arcold.json']['S1'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arcold.json']['S1'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/arcold.json']['S1']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arcold.json']['S1']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/arcold.json']['S1'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/arcold.json']['S1']['ACTION'],X3DJSON['Obj']['Scene']['../data/arcold.json']['S1']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/arcold.json']['S1'].initialize === "function") X3DJSON['Obj']['Scene']['../data/arcold.json']['S1'].initialize();
    if (X3DJSON.nodeUtil("Scene","CL1")) {
X3DJSON.nodeUtil("Scene","CL1").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1'].set_location(X3DJSON.nodeUtil("Scene","CL1","cycleTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1'].set_location(X3DJSON.nodeUtil("Scene","CL1","cycleTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","CL1")) {
...
if (typeof X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1']['ACTION']['keyValue'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1']['ACTION']['keyValue'] = [];
}
X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1']['ACTION']['keyValue'].push(function(property, value) {
		if (property === 'keyValue') {
			X3DJSON.nodeUtil("Scene","PI1","keyValue",typeof X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1'].keyValue === "function" ? X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1'].keyValue() : X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1'].keyValue, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","PI1","keyValue",typeof X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1'].keyValue === "function" ? X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1'].keyValue() : X3DJSON['Obj']['Scene']['../data/arcold.json']['MB1'].keyValue, __eventTime);
