...
X3DJSON['Script']['Scene']['../data/bubs2.json']['bounce'] = function() {
...
X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'] = new X3DJSON['Script']['Scene']['../data/bubs2.json']['bounce']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce']['ACTION'],X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].initialize === "function") X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].initialize();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce']['ACTION']['translation'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce']['ACTION']['translation'] = [];
}
X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce']['ACTION']['translation'].push(function(property, value) {
		if (property === 'translation') {
			X3DJSON.nodeUtil("Scene","body_trans","translation",typeof X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].translation_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].translation_changed() : X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].translation, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","body_trans","translation",typeof X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].translation_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].translation_changed() : X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].translation, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce']['ACTION']['scale'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce']['ACTION']['scale'] = [];
}
X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce']['ACTION']['scale'].push(function(property, value) {
		if (property === 'scale') {
			X3DJSON.nodeUtil("Scene","body_trans","scale",typeof X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].scale_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].scale_changed() : X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].scale, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","body_trans","scale",typeof X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].scale_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].scale_changed() : X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].scale, __eventTime);
    if (X3DJSON.nodeUtil("Scene","bubbleClock")) {
X3DJSON.nodeUtil("Scene","bubbleClock").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].set_fraction(X3DJSON.nodeUtil("Scene","bubbleClock","fraction"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].set_fraction(X3DJSON.nodeUtil("Scene","bubbleClock","fraction"), __eventTime);
			X3DJSON.nodeUtil("Scene","body_trans","translation",typeof X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].translation_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].translation_changed() : X3DJSON['Obj']['Scene']['../data/bubs2.json']['bounce'].translation, __eventTime);
