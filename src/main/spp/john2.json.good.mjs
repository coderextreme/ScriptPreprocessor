...
if (typeof X3DJSON['Scene../data/john2.json'] === 'undefined') {
	X3DJSON['Scene../data/john2.json'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/john2.json'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/john2.json'] = {};
}

X3DJSON['Script']['Scene']['../data/john2.json']['UrlSelector'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/john2.json'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/john2.json'] = {};
}

X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'] = new X3DJSON['Script']['Scene']['../data/john2.json']['UrlSelector']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION'],X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].initialize === "function") X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].initialize();
    if (X3DJSON.nodeUtil("Scene","Clock")) {
X3DJSON.nodeUtil("Scene","Clock").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].set_fraction(X3DJSON.nodeUtil("Scene","Clock","fraction"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].set_fraction(X3DJSON.nodeUtil("Scene","Clock","fraction"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['front'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['front'] = [];
}
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['front'].push(function(property, value) {
		if (property === 'front') {
			X3DJSON.nodeUtil("Scene","background","frontUrl",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].front === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].front() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].front, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","background","frontUrl",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].front === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].front() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].front, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['back'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['back'] = [];
}
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['back'].push(function(property, value) {
		if (property === 'back') {
			X3DJSON.nodeUtil("Scene","background","backUrl",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].back === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].back() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].back, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","background","backUrl",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].back === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].back() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].back, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['left'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['left'] = [];
}
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['left'].push(function(property, value) {
		if (property === 'left') {
			X3DJSON.nodeUtil("Scene","background","leftUrl",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].left === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].left() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].left, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","background","leftUrl",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].left === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].left() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].left, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['right'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['right'] = [];
}
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['right'].push(function(property, value) {
		if (property === 'right') {
			X3DJSON.nodeUtil("Scene","background","rightUrl",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].right === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].right() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].right, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","background","rightUrl",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].right === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].right() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].right, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['top'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['top'] = [];
}
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['top'].push(function(property, value) {
		if (property === 'top') {
			X3DJSON.nodeUtil("Scene","background","topUrl",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].top === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].top() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].top, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","background","topUrl",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].top === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].top() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].top, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['bottom'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['bottom'] = [];
}
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['bottom'].push(function(property, value) {
		if (property === 'bottom') {
			X3DJSON.nodeUtil("Scene","background","bottomUrl",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].bottom === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].bottom() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].bottom, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","background","bottomUrl",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].bottom === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].bottom() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].bottom, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['front'].push(function(property, value) {
		if (property === 'front') {
			X3DJSON.nodeUtil("Scene","front","url",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].front === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].front() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].front, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","front","url",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].front === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].front() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].front, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['back'].push(function(property, value) {
		if (property === 'back') {
			X3DJSON.nodeUtil("Scene","back","url",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].back === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].back() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].back, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","back","url",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].back === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].back() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].back, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['left'].push(function(property, value) {
		if (property === 'left') {
			X3DJSON.nodeUtil("Scene","left","url",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].left === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].left() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].left, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","left","url",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].left === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].left() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].left, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['right'].push(function(property, value) {
		if (property === 'right') {
			X3DJSON.nodeUtil("Scene","right","url",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].right === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].right() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].right, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","right","url",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].right === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].right() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].right, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['top'].push(function(property, value) {
		if (property === 'top') {
			X3DJSON.nodeUtil("Scene","top","url",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].top === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].top() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].top, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","top","url",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].top === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].top() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].top, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector']['ACTION']['bottom'].push(function(property, value) {
		if (property === 'bottom') {
			X3DJSON.nodeUtil("Scene","bottom","url",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].bottom === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].bottom() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].bottom, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","bottom","url",typeof X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].bottom === "function" ? X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].bottom() : X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].bottom, __eventTime);
			X3DJSON['Obj']['Scene']['../data/john2.json']['UrlSelector'].set_fraction(X3DJSON.nodeUtil("Scene","Clock","fraction"), __eventTime);
