...
if (typeof X3DJSON['SceneC:/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json'] === 'undefined') {
	X3DJSON['SceneC:/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json'] === 'undefined') {
X3DJSON['Script']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json'] = {};
}

X3DJSON['Script']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'] = function() {
	...
	try {
		this.endPosition = new SFVec3f(0,1,0);
	} catch (e) {
		console.log('Problems setting endPosition '+e);
		console.error('Problems setting endPosition',e);
	}
	...
	try {
		this.incrementInterval = new SFFloat(0.1);
	} catch (e) {
		console.log('Problems setting incrementInterval '+e);
		console.error('Problems setting incrementInterval',e);
	}
	...
	this.set_partialIncrement = function (value) {
		try {
			this.proxy.partialIncrement = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting partialIncrement '+e);
			console.error('Problems setting partialIncrement',e);
		}
	};
	this.partialIncrement_changed = function () {
		var value = this.partialIncrement;
		return value;
	};
	try {
		this.partialIncrement = new SFFloat(0);
	} catch (e) {
		console.log('Problems setting partialIncrement '+e);
		console.error('Problems setting partialIncrement',e);
	}
	...
	this.setValue = function (inputValue, timeStamp)
{
	...
	this.tracePrint('this.proxy.valueChanged=' + this.proxy.valueChanged);
}
;
	...
	this.bottomEndTouched = function (inputValue, timeStamp)
{
	...
	if (this.proxy.value <= Math.round(this.proxy.value))
		this.proxy.value = Math.round(this.proxy.value);
	else
		this.proxy.value = Math.round(this.proxy.value) + 1;

	this.proxy.partialIncrement = this.proxy.incrementInterval * (this.proxy.valueChanged - (this.proxy.value - 1));

	if (this.proxy.value > this.proxy.min)
	{
		this.proxy.valueChanged = --this.proxy.value;
		if (this.proxy.partialIncrement != this.proxy.incrementInterval)
		{
			this.proxy.ballPositionChanged = new SFVec3f(0, this.proxy.lastBallPosition.y - this.proxy.partialIncrement, 0);
			this.proxy.partialIncrement = this.proxy.incrementInterval;
		}
		else    this.proxy.ballPositionChanged = new SFVec3f(0, this.proxy.lastBallPosition.y - this.proxy.incrementInterval, 0);
		this.proxy.lastBallPosition = this.proxy.ballPositionChanged;
	}
}
;
	...
	this.topEndTouched = function (inputValue, timeStamp)
{
	...
	if (this.proxy.value < Math.round(this.proxy.value))
		this.proxy.value = Math.round(this.proxy.value) - 1;
	else    this.proxy.value = Math.round(this.proxy.value);

	this.proxy.partialIncrement = this.proxy.incrementInterval * (this.proxy.value + 1 - this.proxy.valueChanged);
...
{
	this.tracePrint('this.proxy.setBallPosition(' + inputValue.toString() + ')');
	...
	if (inputValue.y > this.proxy.lastBallPosition.y) // moving upwards
	{
		...
		{
			this.proxy.value = (inputValue.y - this.proxy.beginPosition.y) * ((this.proxy.max - this.proxy.min) / (this.proxy.endPosition.y - this.proxy.beginPosition.y));
			this.proxy.lastBallPosition = inputValue;
		}
		this.proxy.valueChanged = this.proxy.value;
...
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json'] = {};
}

X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'] = new X3DJSON['Script']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']['ACTION'] = {};
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']['ACTION'],X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']);
}
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].initialize === "function") X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript'] = function() {
...
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript'] = new X3DJSON['Script']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript']['ACTION'] = {};
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript']['ACTION'],X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript']);
}
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript'].initialize === "function") X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript'].initialize();
...
X3DJSON.nodeUtil("Scene","SliderBallPlaneSensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].setBallPosition(X3DJSON.nodeUtil("Scene","SliderBallPlaneSensor","translation"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].setBallPosition(X3DJSON.nodeUtil("Scene","SliderBallPlaneSensor","translation"), __eventTime);
...
X3DJSON.nodeUtil("Scene","BottomEndSensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].bottomEndTouched(X3DJSON.nodeUtil("Scene","BottomEndSensor","isActive"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].bottomEndTouched(X3DJSON.nodeUtil("Scene","BottomEndSensor","isActive"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","TopEndSensor")) {
X3DJSON.nodeUtil("Scene","TopEndSensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].topEndTouched(X3DJSON.nodeUtil("Scene","TopEndSensor","isActive"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].topEndTouched(X3DJSON.nodeUtil("Scene","TopEndSensor","isActive"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']['ACTION']['minBallPositionChanged'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']['ACTION']['minBallPositionChanged'] = [];
}
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']['ACTION']['minBallPositionChanged'].push(function(property, value) {
		if (property === 'minBallPositionChanged') {
			X3DJSON.nodeUtil("Scene","SliderBallPlaneSensor","minPosition",typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].minBallPositionChanged === "function" ? X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].minBallPositionChanged() : X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].minBallPositionChanged, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","SliderBallPlaneSensor","minPosition",typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].minBallPositionChanged === "function" ? X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].minBallPositionChanged() : X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].minBallPositionChanged, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']['ACTION']['maxBallPositionChanged'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']['ACTION']['maxBallPositionChanged'] = [];
}
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']['ACTION']['maxBallPositionChanged'].push(function(property, value) {
		if (property === 'maxBallPositionChanged') {
			X3DJSON.nodeUtil("Scene","SliderBallPlaneSensor","maxPosition",typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].maxBallPositionChanged === "function" ? X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].maxBallPositionChanged() : X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].maxBallPositionChanged, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","SliderBallPlaneSensor","maxPosition",typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].maxBallPositionChanged === "function" ? X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].maxBallPositionChanged() : X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].maxBallPositionChanged, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']['ACTION']['bottomEndPositionChanged'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']['ACTION']['bottomEndPositionChanged'] = [];
}
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']['ACTION']['bottomEndPositionChanged'].push(function(property, value) {
		if (property === 'bottomEndPositionChanged') {
			X3DJSON.nodeUtil("Scene","BottomEndTransform","translation",typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].bottomEndPositionChanged === "function" ? X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].bottomEndPositionChanged() : X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].bottomEndPositionChanged, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","BottomEndTransform","translation",typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].bottomEndPositionChanged === "function" ? X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].bottomEndPositionChanged() : X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].bottomEndPositionChanged, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']['ACTION']['topEndPositionChanged'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']['ACTION']['topEndPositionChanged'] = [];
}
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']['ACTION']['topEndPositionChanged'].push(function(property, value) {
		if (property === 'topEndPositionChanged') {
			X3DJSON.nodeUtil("Scene","TopEndTransform","translation",typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].topEndPositionChanged === "function" ? X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].topEndPositionChanged() : X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].topEndPositionChanged, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","TopEndTransform","translation",typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].topEndPositionChanged === "function" ? X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].topEndPositionChanged() : X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].topEndPositionChanged, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']['ACTION']['ballPositionChanged'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']['ACTION']['ballPositionChanged'] = [];
}
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript']['ACTION']['ballPositionChanged'].push(function(property, value) {
		if (property === 'ballPositionChanged') {
			X3DJSON.nodeUtil("Scene","SliderBallTransform","translation",typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].ballPositionChanged === "function" ? X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].ballPositionChanged() : X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].ballPositionChanged, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","SliderBallTransform","translation",typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].ballPositionChanged === "function" ? X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].ballPositionChanged() : X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].ballPositionChanged, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript']['ACTION']['directionRotation'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript']['ACTION']['directionRotation'] = [];
}
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript']['ACTION']['directionRotation'].push(function(property, value) {
		if (property === 'directionRotation') {
			X3DJSON.nodeUtil("Scene","LayoutDirectionTransform","rotation",typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript'].directionRotation === "function" ? X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript'].directionRotation() : X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript'].directionRotation, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","LayoutDirectionTransform","rotation",typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript'].directionRotation === "function" ? X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript'].directionRotation() : X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['LayoutDirectionScript'].directionRotation, __eventTime);
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Tools/Animation/SliderFloatPrototype.json']['SliderScript'].setBallPosition(X3DJSON.nodeUtil("Scene","SliderBallPlaneSensor","translation"), __eventTime);
