...
if (typeof X3DJSON['SceneC:/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/ShipsMilitary/FrigateYavuzTurkey/Mk45.json'] === 'undefined') {
	X3DJSON['SceneC:/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/ShipsMilitary/FrigateYavuzTurkey/Mk45.json'] = {};
}

    if (X3DJSON.nodeUtil("Scene","CannonSense")) {
X3DJSON.nodeUtil("Scene","CannonSense").addEventListener('outputchange', function(event) {
}, false);
}
...
X3DJSON.nodeUtil("Scene","TransparencyInterp").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","FireButtonSensor")) {
X3DJSON.nodeUtil("Scene","FireButtonSensor").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","FireButtonSensor")) {
X3DJSON.nodeUtil("Scene","FireButtonSensor").addEventListener('outputchange', function(event) {
