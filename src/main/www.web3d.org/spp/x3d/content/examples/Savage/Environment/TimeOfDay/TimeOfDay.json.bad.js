...
X3DJSON.nodeUtil("Scene","ClockMechanism").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","ClockMechanism")) {
X3DJSON.nodeUtil("Scene","ClockMechanism").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Environment/TimeOfDay/TimeOfDay.json']['S'].set_rotation(X3DJSON.nodeUtil("Scene","ClockMechanism","secondHand"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/Savage/Environment/TimeOfDay/TimeOfDay.json']['S'].set_rotation(X3DJSON.nodeUtil("Scene","ClockMechanism","secondHand"), __eventTime);
