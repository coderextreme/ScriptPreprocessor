...
if (typeof X3DJSON['SceneC:/Users/jcarl/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/BooleanSequencerPumpHouse.json'] === 'undefined') {
	X3DJSON['SceneC:/Users/jcarl/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/BooleanSequencerPumpHouse.json'] = {};
}
...
X3DJSON.nodeUtil("Scene","PistonClock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","OnOffSequencer")) {
X3DJSON.nodeUtil("Scene","OnOffSequencer").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","InterruptTimer")) {
X3DJSON.nodeUtil("Scene","InterruptTimer").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","InterruptPump")) {
X3DJSON.nodeUtil("Scene","InterruptPump").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","PistonClock")) {
X3DJSON.nodeUtil("Scene","PistonClock").addEventListener('outputchange', function(event) {
