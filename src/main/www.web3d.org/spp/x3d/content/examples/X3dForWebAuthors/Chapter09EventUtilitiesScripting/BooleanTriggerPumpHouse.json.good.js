...
if (typeof X3DJSON['SceneC:/Users/jcarl/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/BooleanTriggerPumpHouse.json'] === 'undefined') {
	X3DJSON['SceneC:/Users/jcarl/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/BooleanTriggerPumpHouse.json'] = {};
}
...
X3DJSON.nodeUtil("Scene","PumpTouched").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","TriggerStart")) {
X3DJSON.nodeUtil("Scene","TriggerStart").addEventListener('outputchange', function(event) {
}, false);
}
