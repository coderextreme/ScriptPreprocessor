...
if (typeof X3DJSON['SceneC:/Users/jcarl/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/IntegerSequencerPumpHouse.json'] === 'undefined') {
	X3DJSON['SceneC:/Users/jcarl/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/IntegerSequencerPumpHouse.json'] = {};
}
...
X3DJSON.nodeUtil("Scene","Timer").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Sequencer")) {
X3DJSON.nodeUtil("Scene","Sequencer").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/IntegerSequencerPumpHouse.json']['Switcher'].whichChoice(X3DJSON.nodeUtil("Scene","Sequencer","value"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/IntegerSequencerPumpHouse.json']['Switcher'].whichChoice(X3DJSON.nodeUtil("Scene","Sequencer","value"), __eventTime);
