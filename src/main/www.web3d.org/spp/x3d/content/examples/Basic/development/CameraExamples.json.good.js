...
if (typeof X3DJSON['SceneC:/Users/jcarl/www.web3d.org/x3d/content/examples/Basic/development/CameraExamples.json'] === 'undefined') {
	X3DJSON['SceneC:/Users/jcarl/www.web3d.org/x3d/content/examples/Basic/development/CameraExamples.json'] = {};
}

    if (X3DJSON.nodeUtil("Scene","Camera.SimpleShotsTest")) {
X3DJSON.nodeUtil("Scene","Camera.SimpleShotsTest").addEventListener('outputchange', function(event) {
}, false);
}
...
X3DJSON.nodeUtil("Scene","TextTouch.SimpleShots").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Camera.AimPointTest")) {
X3DJSON.nodeUtil("Scene","Camera.AimPointTest").addEventListener('outputchange', function(event) {
}, false);
}
