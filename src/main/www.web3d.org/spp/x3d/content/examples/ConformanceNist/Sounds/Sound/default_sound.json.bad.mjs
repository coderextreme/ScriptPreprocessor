...
if (typeof X3DJSON['SceneC:/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json'] === 'undefined') {
	X3DJSON['SceneC:/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json'] === 'undefined') {
X3DJSON['Script']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json'] = {};
}

X3DJSON['Script']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'] = function() {
	this.set_outsideFront = function (value) {
		try {
			this.proxy.outsideFront = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting outsideFront '+e);
			console.error('Problems setting outsideFront',e);
		}
	};
	this.outsideFront_changed = function () {
		var value = this.outsideFront;
		return value;
	};
	try {
		this.outsideFront = new SFVec3f(0,0,60);
	} catch (e) {
		console.log('Problems setting outsideFront '+e);
		console.error('Problems setting outsideFront',e);
	}
	...
	this.set_outsideMaxFront = function (value) {
		try {
			this.proxy.outsideMaxFront = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting outsideMaxFront '+e);
			console.error('Problems setting outsideMaxFront',e);
		}
	};
	this.outsideMaxFront_changed = function () {
		var value = this.outsideMaxFront;
		return value;
	};
	try {
		this.outsideMaxFront = X3DJSON.nodeUtil("Scene","OUTSIDEMAXFRONT");
	} catch (e) {
		console.log('Problems setting outsideMaxFront '+e);
		console.error('Problems setting outsideMaxFront',e);
	}
	...
	try {
		this.minLeftString = new MFString("At min ellipsoid left (max sound)");
	} catch (e) {
		console.log('Problems setting minLeftString '+e);
		console.error('Problems setting minLeftString',e);
	}
	...
	try {
		this.minCenterBottomString = new MFString("At min ellipsoid bottom (max sound)");
	} catch (e) {
		console.log('Problems setting minCenterBottomString '+e);
		console.error('Problems setting minCenterBottomString',e);
	}
...
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json'] = {};
}

X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'] = new X3DJSON['Script']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT']['ACTION'] = {};
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT']['ACTION'],X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT']);
}
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].initialize === "function") X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].initialize();
...
X3DJSON.nodeUtil("Scene","OUTSIDEMAXFRONT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printOutsideMaxFront(X3DJSON.nodeUtil("Scene","OUTSIDEMAXFRONT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printOutsideMaxFront(X3DJSON.nodeUtil("Scene","OUTSIDEMAXFRONT","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXFRONT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printJustOutsideMaxFront(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXFRONT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printJustOutsideMaxFront(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXFRONT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","BETWEENFRONT")) {
X3DJSON.nodeUtil("Scene","BETWEENFRONT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printBetweenFront(X3DJSON.nodeUtil("Scene","BETWEENFRONT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printBetweenFront(X3DJSON.nodeUtil("Scene","BETWEENFRONT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MINFRONT")) {
X3DJSON.nodeUtil("Scene","MINFRONT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinFront(X3DJSON.nodeUtil("Scene","MINFRONT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinFront(X3DJSON.nodeUtil("Scene","MINFRONT","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","MINCENTERFRONT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinCenterFront(X3DJSON.nodeUtil("Scene","MINCENTERFRONT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinCenterFront(X3DJSON.nodeUtil("Scene","MINCENTERFRONT","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","OUTSIDEMAXRIGHT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printOutsideMaxRight(X3DJSON.nodeUtil("Scene","OUTSIDEMAXRIGHT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printOutsideMaxRight(X3DJSON.nodeUtil("Scene","OUTSIDEMAXRIGHT","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXRIGHT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printJustOutsideMaxRight(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXRIGHT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printJustOutsideMaxRight(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXRIGHT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","BETWEENRIGHT")) {
X3DJSON.nodeUtil("Scene","BETWEENRIGHT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printBetweenRight(X3DJSON.nodeUtil("Scene","BETWEENRIGHT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printBetweenRight(X3DJSON.nodeUtil("Scene","BETWEENRIGHT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MINRIGHT")) {
X3DJSON.nodeUtil("Scene","MINRIGHT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinRight(X3DJSON.nodeUtil("Scene","MINRIGHT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinRight(X3DJSON.nodeUtil("Scene","MINRIGHT","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","MINCENTERRIGHT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinCenterRight(X3DJSON.nodeUtil("Scene","MINCENTERRIGHT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinCenterRight(X3DJSON.nodeUtil("Scene","MINCENTERRIGHT","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","OUTSIDEMAXREAR").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printOutsideMaxRear(X3DJSON.nodeUtil("Scene","OUTSIDEMAXREAR","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printOutsideMaxRear(X3DJSON.nodeUtil("Scene","OUTSIDEMAXREAR","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXREAR").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printJustOutsideMaxRear(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXREAR","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printJustOutsideMaxRear(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXREAR","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","BETWEENREAR")) {
X3DJSON.nodeUtil("Scene","BETWEENREAR").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printBetweenRear(X3DJSON.nodeUtil("Scene","BETWEENREAR","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printBetweenRear(X3DJSON.nodeUtil("Scene","BETWEENREAR","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MINREAR")) {
X3DJSON.nodeUtil("Scene","MINREAR").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinRear(X3DJSON.nodeUtil("Scene","MINREAR","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinRear(X3DJSON.nodeUtil("Scene","MINREAR","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MINCENTERREAR")) {
X3DJSON.nodeUtil("Scene","MINCENTERREAR").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinCenterRear(X3DJSON.nodeUtil("Scene","MINCENTERREAR","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinCenterRear(X3DJSON.nodeUtil("Scene","MINCENTERREAR","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","OUTSIDEMAXLEFT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printOutsideMaxLeft(X3DJSON.nodeUtil("Scene","OUTSIDEMAXLEFT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printOutsideMaxLeft(X3DJSON.nodeUtil("Scene","OUTSIDEMAXLEFT","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXLEFT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printJustOutsideMaxLeft(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXLEFT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printJustOutsideMaxLeft(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXLEFT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","BETWEENLEFT")) {
X3DJSON.nodeUtil("Scene","BETWEENLEFT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printBetweenLeft(X3DJSON.nodeUtil("Scene","BETWEENLEFT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printBetweenLeft(X3DJSON.nodeUtil("Scene","BETWEENLEFT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MINLEFT")) {
X3DJSON.nodeUtil("Scene","MINLEFT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinLeft(X3DJSON.nodeUtil("Scene","MINLEFT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinLeft(X3DJSON.nodeUtil("Scene","MINLEFT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MINCENTERLEFT")) {
X3DJSON.nodeUtil("Scene","MINCENTERLEFT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinCenterLeft(X3DJSON.nodeUtil("Scene","MINCENTERLEFT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinCenterLeft(X3DJSON.nodeUtil("Scene","MINCENTERLEFT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","OUTSIDEMAXTOP")) {
X3DJSON.nodeUtil("Scene","OUTSIDEMAXTOP").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printOutsideMaxTop(X3DJSON.nodeUtil("Scene","OUTSIDEMAXTOP","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printOutsideMaxTop(X3DJSON.nodeUtil("Scene","OUTSIDEMAXTOP","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXTOP").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printJustOutsideMaxTop(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXTOP","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printJustOutsideMaxTop(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXTOP","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","BETWEENTOP")) {
X3DJSON.nodeUtil("Scene","BETWEENTOP").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printBetweenTop(X3DJSON.nodeUtil("Scene","BETWEENTOP","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printBetweenTop(X3DJSON.nodeUtil("Scene","BETWEENTOP","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MINTOP")) {
X3DJSON.nodeUtil("Scene","MINTOP").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinTop(X3DJSON.nodeUtil("Scene","MINTOP","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinTop(X3DJSON.nodeUtil("Scene","MINTOP","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MINCENTERTOP")) {
X3DJSON.nodeUtil("Scene","MINCENTERTOP").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinCenterTop(X3DJSON.nodeUtil("Scene","MINCENTERTOP","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinCenterTop(X3DJSON.nodeUtil("Scene","MINCENTERTOP","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","OUTSIDEMAXBOTTOM").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printOutsideMaxBottom(X3DJSON.nodeUtil("Scene","OUTSIDEMAXBOTTOM","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printOutsideMaxBottom(X3DJSON.nodeUtil("Scene","OUTSIDEMAXBOTTOM","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXBOTTOM").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printJustOutsideMaxBottom(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXBOTTOM","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printJustOutsideMaxBottom(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXBOTTOM","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","BETWEENBOTTOM")) {
X3DJSON.nodeUtil("Scene","BETWEENBOTTOM").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printBetweenBottom(X3DJSON.nodeUtil("Scene","BETWEENBOTTOM","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printBetweenBottom(X3DJSON.nodeUtil("Scene","BETWEENBOTTOM","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MINBOTTOM")) {
X3DJSON.nodeUtil("Scene","MINBOTTOM").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinBottom(X3DJSON.nodeUtil("Scene","MINBOTTOM","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinBottom(X3DJSON.nodeUtil("Scene","MINBOTTOM","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","MINCENTERBOTTOM").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinCenterBottom(X3DJSON.nodeUtil("Scene","MINCENTERBOTTOM","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.json']['AVATARSCRIPT'].printMinCenterBottom(X3DJSON.nodeUtil("Scene","MINCENTERBOTTOM","isBound"), __eventTime);
