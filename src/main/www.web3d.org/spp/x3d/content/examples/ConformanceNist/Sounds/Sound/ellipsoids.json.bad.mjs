...
if (typeof X3DJSON['SceneC:/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json'] === 'undefined') {
	X3DJSON['SceneC:/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json'] === 'undefined') {
X3DJSON['Script']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json'] = {};
}

X3DJSON['Script']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'] = function() {
	...
	this.set_justInsideMaxFrontString = function (value) {
		try {
			this.proxy.justInsideMaxFrontString = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting justInsideMaxFrontString '+e);
			console.error('Problems setting justInsideMaxFrontString',e);
		}
	};
	this.justInsideMaxFrontString_changed = function () {
		var value = this.justInsideMaxFrontString;
		return value;
	};
	try {
		this.justInsideMaxFrontString = new MFString("Just inside maxFront (no sound)");
	} catch (e) {
		console.log('Problems setting justInsideMaxFrontString '+e);
		console.error('Problems setting justInsideMaxFrontString',e);
	}
	...
	this.set_justInsideMaxRightString = function (value) {
		try {
			this.proxy.justInsideMaxRightString = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting justInsideMaxRightString '+e);
			console.error('Problems setting justInsideMaxRightString',e);
		}
	};
	this.justInsideMaxRightString_changed = function () {
		var value = this.justInsideMaxRightString;
		return value;
	};
	try {
		this.justInsideMaxRightString = new MFString("Just inside max ellipsoid (no sound)");
	} catch (e) {
		console.log('Problems setting justInsideMaxRightString '+e);
		console.error('Problems setting justInsideMaxRightString',e);
	}
	...
	this.set_justInsideMaxRearString = function (value) {
		try {
			this.proxy.justInsideMaxRearString = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting justInsideMaxRearString '+e);
			console.error('Problems setting justInsideMaxRearString',e);
		}
	};
	this.justInsideMaxRearString_changed = function () {
		var value = this.justInsideMaxRearString;
		return value;
	};
	try {
		this.justInsideMaxRearString = new MFString("Just inside maxBack (no sound)");
	} catch (e) {
		console.log('Problems setting justInsideMaxRearString '+e);
		console.error('Problems setting justInsideMaxRearString',e);
	}
	...
	this.set_justInsideMaxLeftString = function (value) {
		try {
			this.proxy.justInsideMaxLeftString = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting justInsideMaxLeftString '+e);
			console.error('Problems setting justInsideMaxLeftString',e);
		}
	};
	this.justInsideMaxLeftString_changed = function () {
		var value = this.justInsideMaxLeftString;
		return value;
	};
	try {
		this.justInsideMaxLeftString = new MFString("Just inside max ellipsoid (no sound)");
	} catch (e) {
		console.log('Problems setting justInsideMaxLeftString '+e);
		console.error('Problems setting justInsideMaxLeftString',e);
	}
	...
	this.set_justInsideMaxTopString = function (value) {
		try {
			this.proxy.justInsideMaxTopString = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting justInsideMaxTopString '+e);
			console.error('Problems setting justInsideMaxTopString',e);
		}
	};
	this.justInsideMaxTopString_changed = function () {
		var value = this.justInsideMaxTopString;
		return value;
	};
	try {
		this.justInsideMaxTopString = new MFString("Just inside max ellipsoid (no sound)");
	} catch (e) {
		console.log('Problems setting justInsideMaxTopString '+e);
		console.error('Problems setting justInsideMaxTopString',e);
	}
	...
	this.set_justInsideMaxBottomString = function (value) {
		try {
			this.proxy.justInsideMaxBottomString = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting justInsideMaxBottomString '+e);
			console.error('Problems setting justInsideMaxBottomString',e);
		}
	};
	this.justInsideMaxBottomString_changed = function () {
		var value = this.justInsideMaxBottomString;
		return value;
	};
	try {
		this.justInsideMaxBottomString = new MFString("Just inside max ellipsoid (no sound)");
	} catch (e) {
		console.log('Problems setting justInsideMaxBottomString '+e);
		console.error('Problems setting justInsideMaxBottomString',e);
	}
...
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json'] = {};
}

X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'] = new X3DJSON['Script']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT']['ACTION'] = {};
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT']['ACTION'],X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT']);
}
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].initialize === "function") X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].initialize();
...
X3DJSON.nodeUtil("Scene","OUTSIDEMAXFRONT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printOutsideMaxFront(X3DJSON.nodeUtil("Scene","OUTSIDEMAXFRONT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printOutsideMaxFront(X3DJSON.nodeUtil("Scene","OUTSIDEMAXFRONT","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXFRONT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printJustOutsideMaxFront(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXFRONT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printJustOutsideMaxFront(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXFRONT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","BETWEENFRONT")) {
X3DJSON.nodeUtil("Scene","BETWEENFRONT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printBetweenFront(X3DJSON.nodeUtil("Scene","BETWEENFRONT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printBetweenFront(X3DJSON.nodeUtil("Scene","BETWEENFRONT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MINFRONT")) {
X3DJSON.nodeUtil("Scene","MINFRONT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinFront(X3DJSON.nodeUtil("Scene","MINFRONT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinFront(X3DJSON.nodeUtil("Scene","MINFRONT","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","MINCENTERFRONT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinCenterFront(X3DJSON.nodeUtil("Scene","MINCENTERFRONT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinCenterFront(X3DJSON.nodeUtil("Scene","MINCENTERFRONT","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","OUTSIDEMAXRIGHT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printOutsideMaxRight(X3DJSON.nodeUtil("Scene","OUTSIDEMAXRIGHT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printOutsideMaxRight(X3DJSON.nodeUtil("Scene","OUTSIDEMAXRIGHT","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXRIGHT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printJustOutsideMaxRight(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXRIGHT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printJustOutsideMaxRight(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXRIGHT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","BETWEENRIGHT")) {
X3DJSON.nodeUtil("Scene","BETWEENRIGHT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printBetweenRight(X3DJSON.nodeUtil("Scene","BETWEENRIGHT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printBetweenRight(X3DJSON.nodeUtil("Scene","BETWEENRIGHT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MINRIGHT")) {
X3DJSON.nodeUtil("Scene","MINRIGHT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinRight(X3DJSON.nodeUtil("Scene","MINRIGHT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinRight(X3DJSON.nodeUtil("Scene","MINRIGHT","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","MINCENTERRIGHT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinCenterRight(X3DJSON.nodeUtil("Scene","MINCENTERRIGHT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinCenterRight(X3DJSON.nodeUtil("Scene","MINCENTERRIGHT","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","OUTSIDEMAXREAR").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printOutsideMaxRear(X3DJSON.nodeUtil("Scene","OUTSIDEMAXREAR","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printOutsideMaxRear(X3DJSON.nodeUtil("Scene","OUTSIDEMAXREAR","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXREAR").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printJustOutsideMaxRear(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXREAR","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printJustOutsideMaxRear(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXREAR","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","BETWEENREAR")) {
X3DJSON.nodeUtil("Scene","BETWEENREAR").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printBetweenRear(X3DJSON.nodeUtil("Scene","BETWEENREAR","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printBetweenRear(X3DJSON.nodeUtil("Scene","BETWEENREAR","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MINREAR")) {
X3DJSON.nodeUtil("Scene","MINREAR").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinRear(X3DJSON.nodeUtil("Scene","MINREAR","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinRear(X3DJSON.nodeUtil("Scene","MINREAR","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MINCENTERREAR")) {
X3DJSON.nodeUtil("Scene","MINCENTERREAR").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinCenterRear(X3DJSON.nodeUtil("Scene","MINCENTERREAR","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinCenterRear(X3DJSON.nodeUtil("Scene","MINCENTERREAR","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","OUTSIDEMAXLEFT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printOutsideMaxLeft(X3DJSON.nodeUtil("Scene","OUTSIDEMAXLEFT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printOutsideMaxLeft(X3DJSON.nodeUtil("Scene","OUTSIDEMAXLEFT","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXLEFT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printJustOutsideMaxLeft(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXLEFT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printJustOutsideMaxLeft(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXLEFT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","BETWEENLEFT")) {
X3DJSON.nodeUtil("Scene","BETWEENLEFT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printBetweenLeft(X3DJSON.nodeUtil("Scene","BETWEENLEFT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printBetweenLeft(X3DJSON.nodeUtil("Scene","BETWEENLEFT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MINLEFT")) {
X3DJSON.nodeUtil("Scene","MINLEFT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinLeft(X3DJSON.nodeUtil("Scene","MINLEFT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinLeft(X3DJSON.nodeUtil("Scene","MINLEFT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MINCENTERLEFT")) {
X3DJSON.nodeUtil("Scene","MINCENTERLEFT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinCenterLeft(X3DJSON.nodeUtil("Scene","MINCENTERLEFT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinCenterLeft(X3DJSON.nodeUtil("Scene","MINCENTERLEFT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","OUTSIDEMAXTOP")) {
X3DJSON.nodeUtil("Scene","OUTSIDEMAXTOP").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printOutsideMaxTop(X3DJSON.nodeUtil("Scene","OUTSIDEMAXTOP","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printOutsideMaxTop(X3DJSON.nodeUtil("Scene","OUTSIDEMAXTOP","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXTOP").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printJustOutsideMaxTop(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXTOP","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printJustOutsideMaxTop(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXTOP","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","BETWEENTOP")) {
X3DJSON.nodeUtil("Scene","BETWEENTOP").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printBetweenTop(X3DJSON.nodeUtil("Scene","BETWEENTOP","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printBetweenTop(X3DJSON.nodeUtil("Scene","BETWEENTOP","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MINTOP")) {
X3DJSON.nodeUtil("Scene","MINTOP").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinTop(X3DJSON.nodeUtil("Scene","MINTOP","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinTop(X3DJSON.nodeUtil("Scene","MINTOP","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MINCENTERTOP")) {
X3DJSON.nodeUtil("Scene","MINCENTERTOP").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinCenterTop(X3DJSON.nodeUtil("Scene","MINCENTERTOP","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinCenterTop(X3DJSON.nodeUtil("Scene","MINCENTERTOP","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","OUTSIDEMAXBOTTOM").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printOutsideMaxBottom(X3DJSON.nodeUtil("Scene","OUTSIDEMAXBOTTOM","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printOutsideMaxBottom(X3DJSON.nodeUtil("Scene","OUTSIDEMAXBOTTOM","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXBOTTOM").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printJustOutsideMaxBottom(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXBOTTOM","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printJustOutsideMaxBottom(X3DJSON.nodeUtil("Scene","JUSTOUTSIDEMAXBOTTOM","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","BETWEENBOTTOM")) {
X3DJSON.nodeUtil("Scene","BETWEENBOTTOM").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printBetweenBottom(X3DJSON.nodeUtil("Scene","BETWEENBOTTOM","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printBetweenBottom(X3DJSON.nodeUtil("Scene","BETWEENBOTTOM","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MINBOTTOM")) {
X3DJSON.nodeUtil("Scene","MINBOTTOM").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinBottom(X3DJSON.nodeUtil("Scene","MINBOTTOM","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinBottom(X3DJSON.nodeUtil("Scene","MINBOTTOM","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","MINCENTERBOTTOM").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinCenterBottom(X3DJSON.nodeUtil("Scene","MINCENTERBOTTOM","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/ellipsoids.json']['AVATARSCRIPT'].printMinCenterBottom(X3DJSON.nodeUtil("Scene","MINCENTERBOTTOM","isBound"), __eventTime);
