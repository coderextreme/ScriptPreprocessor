...
if (typeof X3DJSON['SceneC:/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json'] === 'undefined') {
	X3DJSON['SceneC:/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json'] === 'undefined') {
X3DJSON['Script']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json'] = {};
}

X3DJSON['Script']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'] = function() {
	...
	try {
		this.minCenterTopString = new MFString("At ellipsoid center (max sound)");
	} catch (e) {
		console.log('Problems setting minCenterTopString '+e);
		console.error('Problems setting minCenterTopString',e);
	}
	...
	this.set_xMaterial = function (value) {
		try {
			this.proxy.xMaterial = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting xMaterial '+e);
			console.error('Problems setting xMaterial',e);
		}
	};
	this.xMaterial_changed = function () {
		var value = this.xMaterial;
		return value;
	};
	try {
		this.xMaterial = X3DJSON.nodeUtil("Scene","XMATERIAL");
	} catch (e) {
		console.log('Problems setting xMaterial '+e);
		console.error('Problems setting xMaterial',e);
	}
	this.set_yMaterial = function (value) {
		try {
			this.proxy.yMaterial = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting yMaterial '+e);
			console.error('Problems setting yMaterial',e);
		}
	};
	this.yMaterial_changed = function () {
		var value = this.yMaterial;
		return value;
	};
	try {
		this.yMaterial = X3DJSON.nodeUtil("Scene","YMATERIAL");
	} catch (e) {
		console.log('Problems setting yMaterial '+e);
		console.error('Problems setting yMaterial',e);
	}
	this.set_zMaterial = function (value) {
		try {
			this.proxy.zMaterial = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting zMaterial '+e);
			console.error('Problems setting zMaterial',e);
		}
	};
	this.zMaterial_changed = function () {
		var value = this.zMaterial;
		return value;
	};
	try {
		this.zMaterial = X3DJSON.nodeUtil("Scene","ZMATERIAL");
	} catch (e) {
		console.log('Problems setting zMaterial '+e);
		console.error('Problems setting zMaterial',e);
	}
	this.set_sound1 = function (value) {
		try {
			this.proxy.sound1 = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting sound1 '+e);
			console.error('Problems setting sound1',e);
		}
	};
	this.sound1_changed = function () {
		var value = this.sound1;
		return value;
	};
	try {
		this.sound1 = X3DJSON.nodeUtil("Scene","SOUND1");
	} catch (e) {
		console.log('Problems setting sound1 '+e);
		console.error('Problems setting sound1',e);
	}
	this.set_ellipsoid1Color = function (value) {
		try {
			this.proxy.ellipsoid1Color = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting ellipsoid1Color '+e);
			console.error('Problems setting ellipsoid1Color',e);
		}
	};
	this.ellipsoid1Color_changed = function () {
		var value = this.ellipsoid1Color;
		return value;
	};
	try {
		this.ellipsoid1Color = X3DJSON.nodeUtil("Scene","ELLIPSOID1COLOR");
	} catch (e) {
		console.log('Problems setting ellipsoid1Color '+e);
		console.error('Problems setting ellipsoid1Color',e);
	}
	this.set_ellipsoid2Color = function (value) {
		try {
			this.proxy.ellipsoid2Color = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting ellipsoid2Color '+e);
			console.error('Problems setting ellipsoid2Color',e);
		}
	};
	this.ellipsoid2Color_changed = function () {
		var value = this.ellipsoid2Color;
		return value;
	};
	try {
		this.ellipsoid2Color = X3DJSON.nodeUtil("Scene","ELLIPSOID2COLOR");
	} catch (e) {
		console.log('Problems setting ellipsoid2Color '+e);
		console.error('Problems setting ellipsoid2Color',e);
	}
	this.set_ellipsoid3Color = function (value) {
		try {
			this.proxy.ellipsoid3Color = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting ellipsoid3Color '+e);
			console.error('Problems setting ellipsoid3Color',e);
		}
	};
	this.ellipsoid3Color_changed = function () {
		var value = this.ellipsoid3Color;
		return value;
	};
	try {
		this.ellipsoid3Color = X3DJSON.nodeUtil("Scene","ELLIPSOID3COLOR");
	} catch (e) {
		console.log('Problems setting ellipsoid3Color '+e);
		console.error('Problems setting ellipsoid3Color',e);
	}
	...
	try {
		this.white = new MFColor([new SFColor ( 1 , 1 , 1 )]);
	} catch (e) {
		console.log('Problems setting white '+e);
		console.error('Problems setting white',e);
	}
	this.set_red = function (value) {
		try {
			this.proxy.red = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting red '+e);
			console.error('Problems setting red',e);
		}
	};
	this.red_changed = function () {
		var value = this.red;
		return value;
	};
	try {
		this.red = new MFColor([new SFColor ( 1 , 0 , 0 )]);
	} catch (e) {
		console.log('Problems setting red '+e);
		console.error('Problems setting red',e);
	}
	...
	try {
		this.green = new MFColor([new SFColor ( 0 , 1 , 0 )]);
	} catch (e) {
		console.log('Problems setting green '+e);
		console.error('Problems setting green',e);
	}
	this.set_blue = function (value) {
		try {
			this.proxy.blue = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting blue '+e);
			console.error('Problems setting blue',e);
		}
	};
	this.blue_changed = function () {
		var value = this.blue;
		return value;
	};
	try {
		this.blue = new MFColor([new SFColor ( 0 , 0 , 1 )]);
	} catch (e) {
		console.log('Problems setting blue '+e);
		console.error('Problems setting blue',e);
	}
	this.set_sfWhite = function (value) {
		try {
			this.proxy.sfWhite = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting sfWhite '+e);
			console.error('Problems setting sfWhite',e);
		}
	};
	this.sfWhite_changed = function () {
		var value = this.sfWhite;
		return value;
	};
	try {
		this.sfWhite = new SFColor(1,1,1);
	} catch (e) {
		console.log('Problems setting sfWhite '+e);
		console.error('Problems setting sfWhite',e);
	}
	this.set_sfRed = function (value) {
		try {
			this.proxy.sfRed = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting sfRed '+e);
			console.error('Problems setting sfRed',e);
		}
	};
	this.sfRed_changed = function () {
		var value = this.sfRed;
		return value;
	};
	try {
		this.sfRed = new SFColor(1,0,0);
	} catch (e) {
		console.log('Problems setting sfRed '+e);
		console.error('Problems setting sfRed',e);
	}
	this.set_sfGreen = function (value) {
		try {
			this.proxy.sfGreen = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting sfGreen '+e);
			console.error('Problems setting sfGreen',e);
		}
	};
	this.sfGreen_changed = function () {
		var value = this.sfGreen;
		return value;
	};
	try {
		this.sfGreen = new SFColor(0,1,0);
	} catch (e) {
		console.log('Problems setting sfGreen '+e);
		console.error('Problems setting sfGreen',e);
	}
	this.set_sfBlue = function (value) {
		try {
			this.proxy.sfBlue = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting sfBlue '+e);
			console.error('Problems setting sfBlue',e);
		}
	};
	this.sfBlue_changed = function () {
		var value = this.sfBlue;
		return value;
	};
	try {
		this.sfBlue = new SFColor(0,0,1);
	} catch (e) {
		console.log('Problems setting sfBlue '+e);
		console.error('Problems setting sfBlue',e);
	}
	this.set_colorEllipse1 = function (value) {
		try {
			this.proxy.colorEllipse1 = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting colorEllipse1 '+e);
			console.error('Problems setting colorEllipse1',e);
		}
	};
	this.colorEllipse1_changed = function () {
		var value = this.colorEllipse1;
		return value;
	};
	try {
		this.colorEllipse1 = new SFBool();
	} catch (e) {
		console.log('Problems setting colorEllipse1 '+e);
		console.error('Problems setting colorEllipse1',e);
	}
	this.set_colorEllipse2 = function (value) {
		try {
			this.proxy.colorEllipse2 = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting colorEllipse2 '+e);
			console.error('Problems setting colorEllipse2',e);
		}
	};
	this.colorEllipse2_changed = function () {
		var value = this.colorEllipse2;
		return value;
	};
	try {
		this.colorEllipse2 = new SFBool();
	} catch (e) {
		console.log('Problems setting colorEllipse2 '+e);
		console.error('Problems setting colorEllipse2',e);
	}
	this.set_colorEllipse3 = function (value) {
		try {
			this.proxy.colorEllipse3 = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting colorEllipse3 '+e);
			console.error('Problems setting colorEllipse3',e);
		}
	};
	this.colorEllipse3_changed = function () {
		var value = this.colorEllipse3;
		return value;
	};
	try {
		this.colorEllipse3 = new SFBool();
	} catch (e) {
		console.log('Problems setting colorEllipse3 '+e);
		console.error('Problems setting colorEllipse3',e);
	}
	this.set_xAxis = function (value) {
		try {
			this.proxy.xAxis = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting xAxis '+e);
			console.error('Problems setting xAxis',e);
		}
	};
	this.xAxis_changed = function () {
		var value = this.xAxis;
		return value;
	};
	try {
		this.xAxis = new SFVec3f(1,0,0);
	} catch (e) {
		console.log('Problems setting xAxis '+e);
		console.error('Problems setting xAxis',e);
	}
	this.set_yAxis = function (value) {
		try {
			this.proxy.yAxis = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting yAxis '+e);
			console.error('Problems setting yAxis',e);
		}
	};
	this.yAxis_changed = function () {
		var value = this.yAxis;
		return value;
	};
	try {
		this.yAxis = new SFVec3f(0,1,0);
	} catch (e) {
		console.log('Problems setting yAxis '+e);
		console.error('Problems setting yAxis',e);
	}
	this.set_zAxis = function (value) {
		try {
			this.proxy.zAxis = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting zAxis '+e);
			console.error('Problems setting zAxis',e);
		}
	};
	this.zAxis_changed = function () {
		var value = this.zAxis;
		return value;
	};
	try {
		this.zAxis = new SFVec3f(0,0,1);
	} catch (e) {
		console.log('Problems setting zAxis '+e);
		console.error('Problems setting zAxis',e);
	}
...
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json'] = {};
}

X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'] = new X3DJSON['Script']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT']['ACTION'] = {};
X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT']['ACTION'],X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT']);
}
if (typeof X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].initialize === "function") X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].initialize();
...
X3DJSON.nodeUtil("Scene","OUTSIDEMAXFRONT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].printOutsideMaxFront(X3DJSON.nodeUtil("Scene","OUTSIDEMAXFRONT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].printOutsideMaxFront(X3DJSON.nodeUtil("Scene","OUTSIDEMAXFRONT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","BETWEENFRONT")) {
X3DJSON.nodeUtil("Scene","BETWEENFRONT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].printBetweenFront(X3DJSON.nodeUtil("Scene","BETWEENFRONT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].printBetweenFront(X3DJSON.nodeUtil("Scene","BETWEENFRONT","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","OUTSIDEMAXRIGHT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].printOutsideMaxRight(X3DJSON.nodeUtil("Scene","OUTSIDEMAXRIGHT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].printOutsideMaxRight(X3DJSON.nodeUtil("Scene","OUTSIDEMAXRIGHT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","BETWEENRIGHT")) {
X3DJSON.nodeUtil("Scene","BETWEENRIGHT").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].printBetweenRight(X3DJSON.nodeUtil("Scene","BETWEENRIGHT","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].printBetweenRight(X3DJSON.nodeUtil("Scene","BETWEENRIGHT","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","OUTSIDEMAXTOP")) {
X3DJSON.nodeUtil("Scene","OUTSIDEMAXTOP").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].printOutsideMaxTop(X3DJSON.nodeUtil("Scene","OUTSIDEMAXTOP","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].printOutsideMaxTop(X3DJSON.nodeUtil("Scene","OUTSIDEMAXTOP","isBound"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","BETWEENTOP")) {
X3DJSON.nodeUtil("Scene","BETWEENTOP").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].printBetweenTop(X3DJSON.nodeUtil("Scene","BETWEENTOP","isBound"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].printBetweenTop(X3DJSON.nodeUtil("Scene","BETWEENTOP","isBound"), __eventTime);
...
X3DJSON.nodeUtil("Scene","PROX_SENSOR").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","TOUCHX")) {
X3DJSON.nodeUtil("Scene","TOUCHX").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].colorEllipse1(X3DJSON.nodeUtil("Scene","TOUCHX","isActive"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].colorEllipse1(X3DJSON.nodeUtil("Scene","TOUCHX","isActive"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","TOUCHY")) {
X3DJSON.nodeUtil("Scene","TOUCHY").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].colorEllipse2(X3DJSON.nodeUtil("Scene","TOUCHY","isActive"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].colorEllipse2(X3DJSON.nodeUtil("Scene","TOUCHY","isActive"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","TOUCHZ")) {
X3DJSON.nodeUtil("Scene","TOUCHZ").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].colorEllipse3(X3DJSON.nodeUtil("Scene","TOUCHZ","isActive"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].colorEllipse3(X3DJSON.nodeUtil("Scene","TOUCHZ","isActive"), __eventTime);
			X3DJSON['Obj']['Scene']['C']['/Users/jcarl/www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/direction.json']['SOUND_SCRIPT'].printOutsideMaxFront(X3DJSON.nodeUtil("Scene","OUTSIDEMAXFRONT","isBound"), __eventTime);
